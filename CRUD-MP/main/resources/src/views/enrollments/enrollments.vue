...
<script>
  import AddOrUpdate from './components/enrollments-add-or-update'
  import { queryForPage, deleteEnrollments } from '@/api/enrollments/enrollments'
    ...
    methods: {
      ...
      deleteHandle (id) {
        this.$confirm('此操作将永久删除该, 是否继续?', '提示', {
          ...
          try {
            const params = { id }
            await deleteEnrollments(params)
            await this.fetch()
          } catch (error) {
            console.log(error)
          }
