...
<script>
  import AddOrUpdate from './components/scoremanagement-add-or-update'
  import { queryForPage, deleteScoreManagement } from '@/api/scoreManagement/scoreManagement'
    ...
    methods: {
      ...
      deleteHandle (id) {
        this.$confirm('此操作将永久删除该, 是否继续?', '提示', {
          ...
          try {
            const params = { id }
            await deleteScoreManagement(params)
            await this.fetch()
          } catch (error) {
            console.log(error)
          }
